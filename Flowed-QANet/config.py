...
test_file = os.path.join(home, "data", "squad", "test-v2.0.json")
glove_word_file = os.path.join(home, "data", "glove", "glove.840B.300d.txt")
target_dir = "data"
event_dir = "log_large"
save_dir = "model_large"
answer_dir = "log_large"
...
flags.DEFINE_integer("max_ans_limit", 15, "Limit length for answers")
...
flags.DEFINE_integer("batch_size", 18, "Batch size")
#flags.DEFINE_integer("num_steps", 0, "Number of steps")
flags.DEFINE_integer("num_epoch", 25, "Number of epoch")
...
flags.DEFINE_string('split','dev','Split to use for testing')
flags.DEFINE_string('sub_file','submission.csv','Name for submission file.')
config = flags.FLAGS
